...
.. code-block:: php
    ...
    $client = new ImpreseeGuzzleHttp\Client(['base_uri' => 'http://httpbin.org']);
...
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::ALLOW_REDIRECTS``
...
.. warning::
    ...
    ``ImpreseeGuzzleHttp\Middleware::redirect`` middleware. This middleware is added
    by default when a client is created with no handler, and is added by
    default when creating a handler with ``ImpreseeGuzzleHttp\HandlerStack::create``.
...
:Types:
        ...
        - null
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::AUTH``
...
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::BODY``
...
:Types:
        ...
        - array
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::CERT``
...
:Types: ``ImpreseeGuzzleHttp\Cookie\CookieJarInterface``
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::COOKIES``

You must specify the cookies option as a
``ImpreseeGuzzleHttp\Cookie\CookieJarInterface`` or ``false``.

.. code-block:: php

    $jar = new \ImpreseeGuzzleHttp\Cookie\CookieJar();
    $client->request('GET', '/get', ['cookies' => $jar]);

.. warning::

    This option only has an effect if your handler has the
    ``ImpreseeGuzzleHttp\Middleware::cookies`` middleware. This middleware is added
    by default when a client is created with no handler, and is added by
    default when creating a handler with ``ImpreseeGuzzleHttp\default_handler``.
...
:Types: float
:Default: ``0``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::CONNECT_TIMEOUT``
...
:Types:
        ...
        - ``fopen()`` resource
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::DEBUG``
...
:Types:
        ...
        - bool
:Default: ``true``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::DECODE_CONTENT``
...
:Types:
    ...
    - float
:Default: null
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::DELAY``
...
:Types:
    ...
    - integer
:Default: ``1048576``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::EXPECT``
...
:Types: string
:Default: null
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::FORCE_IP_RESOLVE``
...
:Types: array
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::FORM_PARAMS``
...
:Types: array
:Defaults: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::HEADERS``
...
.. code-block:: php
    ...
    $client = new ImpreseeGuzzleHttp\Client(['headers' => ['X-Foo' => 'Bar']]);
...
:Types: bool
:Default: ``true``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::HTTP_ERRORS``

.. code-block:: php

    $client->request('GET', '/status/500');
    // Throws a ImpreseeGuzzleHttp\Exception\ServerException
...
.. warning::
    ...
    This option only has an effect if your handler has the
    ``ImpreseeGuzzleHttp\Middleware::httpErrors`` middleware. This middleware is added
    by default when a client is created with no handler, and is added by
    default when creating a handler with ``ImpreseeGuzzleHttp\default_handler``.
...
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::IDN_CONVERSION``
...
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::JSON``
...
:Types: array
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::MULTIPART``
...
:Types: - callable
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::ON_HEADERS``
...
be rejected with a ``ImpreseeGuzzleHttp\Exception\RequestException`` that wraps the
...
:Summary: ``on_stats`` allows you to get access to transfer statistics of a
    ...
    to send the request.
:Types: - callable
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::ON_STATS``

The callable accepts a ``ImpreseeGuzzleHttp\TransferStats`` object.
...
:Types: - callable
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::PROGRESS``
...
:Types:
    ...
    - array
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::PROXY``
...
:Types:
    ...
    - string
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::QUERY``
...
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::READ_TIMEOUT``
...
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::SINK``
...
:Types:
        ...
        - array
:Default: None
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::SSL_KEY``
...
:Types: bool
:Default: ``false``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::STREAM``
...
:Types: bool
:Default: none
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::SYNCHRONOUS``
...
:Types:
    ...
    - string
:Default: ``true``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::VERIFY``
...
:Types: float
:Default: ``0``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::TIMEOUT``

.. code-block:: php

    // Timeout if a server does not return a response in 3.14 seconds.
    $client->request('GET', '/delay/5', ['timeout' => 3.14]);
    // PHP Fatal error:  Uncaught exception 'ImpreseeGuzzleHttp\Exception\RequestException'
...
:Types: string, float
:Default: ``1.1``
:Constant: ``ImpreseeGuzzleHttp\RequestOptions::VERSION``
